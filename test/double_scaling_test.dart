...
void main() {
  group('Meal Optimization Result and CircadianFeedbackService Double-Scaling Tests', () {
    ...
    test('CircadianFeedbackService should apply fatigue adjustment and update meals without double-scaling', () async {
      ...
      // Crucial Check:
      // Under maintain, kahvalti target ratio is 0.25. 2000 kcal * 0.25 = 500 kcal.
      // The meal generated by optimizer has baseWeightG = 333.33g (150 kcal/100g * 3.3333 = 500 kcal).
      // With our fix, it should be exactly 500.0 kcal (no second scaling applied!).
      expect(newKahvalti.kalori, equals(500.0));
      expect(newKahvalti.baseWeightG, closeTo(333.33, 0.01));
      expect(newKahvalti.protein, closeTo(33.33, 0.01));
      expect(newKahvalti.karbonhidrat, closeTo(66.67, 0.01));
      expect(newKahvalti.yag, closeTo(11.10, 0.01));
    });
  });
}
